...
import Sub2ApiUsagePanel from './Sub2ApiUsagePanel'

interface Sub2ApiUsageModalProps {
  onClose: () => void
}

export default function Sub2ApiUsageModal({ onClose }: Sub2ApiUsageModalProps) {
      ...
      >
        <div className="flex items-center justify-between gap-4 border-b border-gray-200/70 px-5 py-4 dark:border-white/[0.08]">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm font-bold text-gray-800 dark:text-gray-100">使用记录</h3>
          </div>
          <button
            type="button"
            onClick={onClose}
